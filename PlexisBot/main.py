...
class optionsbot(sendorder):
    ...
    async def main(self):
        ...
        Buys OTM call contracts after 2 consecutive green candles

        Buys OTM Put contracts after 2 consecutive red candles

        Scalping can be performed on the 1 minute or 5 minute interval
        """
        # _choice = int(
